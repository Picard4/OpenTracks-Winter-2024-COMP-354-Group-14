...
public class DistanceLeaderboardFragment extends LeaderboardFragment {
    ...
    private List<Ranking> getTestData() {
        ...
        rankings.add(new Ranking(1, "User 1", "A",  Double.toString(20)));
        rankings.add(new Ranking(2, "User 2", "B",  Double.toString(6)));
        ...
        rankings.add(new Ranking(6,  "User 6", "F",  Double.toString(30)));
        rankings.add(new Ranking(7,  "User 7", "G",  Double.toString(19)));
        rankings.add(new Ranking(8,  "User 8", "H",  Double.toString(32)));
        ...
        rankings.add(new Ranking(13,  "User 13", "M",  Double.toString(28)));
    ...
    private List<Ranking> getAltTestData() {
        List<Ranking> rankings = new ArrayList<>();
        rankings.add(new Ranking(1, "First", "Steamboat Springs",  Double.toString(20)));
        rankings.add(new Ranking(2, "Second", "North California CA",  Double.toString(24)));
        rankings.add(new Ranking(3, "Third", "Steamboat Springs, Color Red",  Double.toString(28)));
        ...
        rankings.add(new Ranking(6,  "Sixth", "Montreal",  Double.toString(30)));
        rankings.add(new Ranking(7,  "Seven", "Steamboat Springs",  Double.toString(25)));
        return rankings;
    }
}